...
// //essa é a main comentadinha, para eu lembrar o que eu fiz em cada coisa
...
//   @override
//   Widget build(BuildContext context) {
//     //referenciando o mediaQuery, para aliviar o codigo
...
//               SizedBox(
//                   //aqui no chart da aplicação ele vai pegar o heigth com 70% da tela.
//                   //se estiver no landscape, se não estiver vai ocupar 30
//                   height: availableHeigth * (isLandscape ? 0.7 : 0.3),
//                   child: Chart(_recentTransactions)),
//             //se for falso exibe esse
//             if (!_showChart || !isLandscape)
//               SizedBox(
//                   //aqui no TransactionList da aplicação ele vai pegar o heigth com 90% da tela.
//                   //se estiver no landscap(deitado) senão vai ocupar 70%
//                   height: availableHeigth * (isLandscape ? 0.9 : 0.7),
...
//       //se for no IOS não tera a bolinha de adcionar em baixo.
